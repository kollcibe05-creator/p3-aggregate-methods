...
class Student:
    ...
    def course_content(self):           ##counts the number of student's courses
...
class Course:
    ...
    def get_enrollments(self):
        return self._enrollments.copy()
    ##Assumption ~ calculating student average grade
...
class Enrollment:
    ...
    @classmethod    #to establish how many enrollments were done in a specific day
